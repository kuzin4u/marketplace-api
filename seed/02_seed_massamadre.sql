...
INSERT INTO clearing_splits (id, order_id, participant_id, role, amount, tariff_ref, calculation, status, released_at) VALUES
  ('CLR-001', 'ORD-00001', 'PTR-12345', 'SELLER',      817.16, NULL,      '1420 − 600 − 2.84',   'RELEASED', NOW()),
  ('CLR-002', 'ORD-00001', 'PTR-67891', 'FULFILLMENT',  600.00, 'TRF-001', '3 ед × 200₽',         'RELEASED', NOW()),
  ('CLR-003', 'ORD-00001', 'PTR-88901', 'LOGISTICS',    350.00, 'TRF-005', 'зона 1 = 350₽',       'RELEASED', NOW()),
  ('CLR-004', 'ORD-00001', 'ORG-001',   'ORGANIZER',      2.84, 'TRF-008', '1420 × 0.2%',         'RELEASED', NOW());
